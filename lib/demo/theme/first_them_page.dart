...
import 'package:my_enterprise_app/demo/routes/scend_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: <Widget>[
        ...
        SizedBox(height: 20,),
        ElevatedButton(child: Text("这是一个Button"), onPressed: () {},),
        SizedBox(height: 20,),
        Switch(value: true, onChanged: (bool value) {},),
        Checkbox(onChanged: ( value) {  }, value: true,),
        Radio(groupValue: 1, onChanged: ( value) {  }, value: null,),
      ],),
