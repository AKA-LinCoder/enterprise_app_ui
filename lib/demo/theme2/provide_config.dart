...
//      */
//     ///初始化 providers
//     final providers = Provider(create: (BuildContext context) {  },)..provide(Provider.value(value: ThemConfigModel()));
//
//     /**
...
//     return Provider<T>(builder: builder, child: child, dispose: scope, create: (BuildContext context) {  },);
//   }
//
//
//   // 通过Provide.value<T>(context)获取封装
//   static Provider<Null> value<T>(context, {scope}) {
//     /**
