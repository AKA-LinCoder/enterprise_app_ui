...
import 'package:my_enterprise_app/demo/scaffold/people_item_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:BottomNavigationBar(items: <BottomNavigationBarItem>[
        ///参数一 icon 图标
        BottomNavigationBarItem(icon:Icon(Icons.home,color: index==0?Colors.blue:Colors.grey,),label: "首页",),
        BottomNavigationBarItem(icon:Icon(Icons.email,color: index==1?Colors.blue:Colors.grey,),label: "邮件",),
